        ...
        <div className="max-w-xl">
          ...
          >
            <p className="body-editorial mb-6">
              An elevated penthouse space above the city skyline, created for 
              meaningful conversations and real connection. 
              Intimate, thoughtfully curated, and welcoming to ambitious builders and leaders.
            </p>
